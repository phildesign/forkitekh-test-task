# Тестовое задание Форкитех

### Задача:

Макет - https://www.figma.com/file/AC7XTKOr3fN4wioExuf7r6/T2?node-id=0%3A1
...
- развёрнутый проект, доступный для просмотра по прямой ссылке
- репозиторий на github, в котором можно просмотреть доступный код
